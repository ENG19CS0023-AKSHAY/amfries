...
const en: Dict = {
  ...
  "hero.subtitle": "Freshly cut. Twice fried. The Dutch way — served hot in Koramangala.",
  ...
  "story.body": "Amfries started with one obsession: bringing the real Dutch frite experience to India. We source premium potatoes, hand-cut them daily and fry them twice — the way it should be done. From Koramangala to your fingertips, fresh in every bite.",
  "story.cta": "Read more",
  ...
  "footer.tagline": "Fresh Dutch fries",
